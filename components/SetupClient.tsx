...
const FIELDS = [
  ...
  },
  {
    ...
    label: "FACEBOOK_CLIENT_ID",
    placeholder: "123456789012345",
    hint: "Meta App Dashboard → App settings → Basic → App ID. Dùng cho nút Đăng nhập bằng Facebook.",
    secret: false,
    required: false,
    storage: "env" as const,
  },
  {
    ...
    label: "FACEBOOK_CLIENT_SECRET",
    placeholder: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    hint: "Meta App Dashboard → App settings → Basic → App Secret. Chỉ lưu trên server/Vercel.",
    secret: true,
    required: false,
    storage: "env" as const,
  },
